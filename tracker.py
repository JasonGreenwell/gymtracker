...
# root.mainloop()
assets_folder = "/home/pi/Projects/gymtracker/gymtracker-master/Assets/"
...
wb = openpyxl.load_workbook(assets_folder + 'counter-3.xlsx')
sheet = wb.active
...
def onClick_ad(event=None):
    ...
    sheet['b2'] = str(ad.get())
    wb.save(assets_folder + 'counter-3.xlsx')
